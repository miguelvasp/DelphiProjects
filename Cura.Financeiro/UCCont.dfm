object FCCont: TFCCont
  ...
  object T_CCONT: TTable
    DatabaseName = 'Financeiro'
    SessionName = 'Sec_BaseFin'
    IndexFieldNames = 'CTC_CODI'
    TableName = 'dbo.CPACTCO'
    Left = 176
    Top = 64
    object T_CCONTCTC_CODI: TStringField
      DisplayWidth = 6
      FieldName = 'CTC_CODI'
      Required = True
      FixedChar = True
    ...
    object T_CCONTCTC_DESC: TStringField
      DisplayWidth = 20
      FieldName = 'CTC_DESC'
      Required = True
      FixedChar = True
