...
procedure TFRelReceb.FormCreate(Sender: TObject);
...
procedure TFRelReceb.QRLabel17Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',totliq);
end;

procedure TFRelReceb.QRLabel18Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',totpag);
end;

procedure TFRelReceb.QRLabel19Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',totsal);
end;

procedure TFRelReceb.QRBand3AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
...
procedure TFRelReceb.RelRecebBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
filtro : string;
begin
...
procedure TFRelReceb.QRLabel22Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',TOTLIQF);
end;

procedure TFRelReceb.QRLabel23Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',TOTPAGF);
end;

procedure TFRelReceb.QRLabel24Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',TOTSALF);
end;

procedure TFRelReceb.QRLabel20Print(sender: TObject;
  var Value: String);
begin
   VALUE := FMenu.FUsuario;
end;

procedure TFRelReceb.QRLabel2Print(sender: TObject; var Value: String);
begin
   if TIPO = 0 then
...
procedure TFRelReceb.QRLabel9Print(sender: TObject; var Value: String);
begin
   if rTipo = 0 then
...
procedure TFRelReceb.FormClose(Sender: TObject;
...
procedure TFRelReceb.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
{   if rTipo = 3 then
   begin
...
procedure TFRelReceb.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TFRelReceb.QRGroup2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
   if rTipo <> 3 then
   begin
...
procedure TFRelReceb.QRDBText9Print(sender: TObject; var Value: String);
begin
   if rTipo = 2 then 
