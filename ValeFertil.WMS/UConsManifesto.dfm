object FConsManifesto: TFConsManifesto
  Left = 266
  Top = 61
  Width = 800
  Height = 575
  ...
  object GRID1: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'MANI_DATA'#9'7'#9'Emiss'#227'o'
      'MANI_TIPOCARGA'#9'1'#9'Tp.Carga'
      'VEICdescr'#9'23'#9'Ve'#237'c.Transportador'
      'TranspDESCR'#9'30'#9'Transportadora'
      'MOTdescr'#9'23'#9'Motorista')
  ...
  object DBG_RAAT: TwwDBGrid
    ...
    Selected.Strings = (
      'NFI_NUMERO'#9'8'#9'NF'
      'CLIN_RAZA'#9'23'#9'Emitente'
      'NFI_DTENTREGA'#9'10'#9'Entrega'
      'NFI_DEST_RAZA'#9'35'#9'Destinat'#225'rio'
      'NFI_DEST_ENDERECO'#9'25'#9'Endere'#231'o'
      'NFI_DEST_CEP'#9'8'#9'CEP'
      'MUN_NOME'#9'25'#9'Munic'#237'pio'
      'REG_NOME'#9'25'#9'Regi'#227'o')
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    DisableThemesInTitle = False
    Selected.Strings = (
      'CNF_NF'#9'30'#9'N'#186' NF'#39's'
      'CLIFraza'#9'31'#9'Destinat'#225'rio'
      'CNF_UV'#9'10'#9'UV'#39's'
      'CNF_PESO'#9'10'#9'Peso'
      'CNF_PALLETS'#9'10'#9'Pallet'#39's'
  ...
  object Q_MANIF: TwwQuery
    ...
    SQL.Strings = (
      ...
      'A.REG_ID,'
      'A.MANI_VFRETEPAG'
      'FROM MANIFESTO A,CLIENTENBF B,NF C'
      'where'
    ...
    object Q_MANIFVEICdescr: TStringField
      DisplayLabel = 'Ve'#237'c.Transportador'
      DisplayWidth = 23
      FieldKind = fkLookup
      FieldName = 'VEICdescr'
    ...
    object Q_MANIFRegiao: TStringField
      DisplayWidth = 40
      FieldKind = fkLookup
      FieldName = 'Regiao'
