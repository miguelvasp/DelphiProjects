object FFConsultaCTRC: TFFConsultaCTRC
  Left = 279
  Top = 145
  Width = 772
  Height = 470
  ...
  object Panel2: TPanel
    ...
    object GroupBox6: TGroupBox
      ...
      object combo_cliente_final: TwwDBLookupCombo
        ...
        PreciseEditRegion = False
        AllowClearKey = True
        OnEnter = combo_cliente_finalEnter
        OnExit = combo_cliente_finalExit
      end
  ...
  object qrBuscaOS: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT DISTINCT  OS_ID FROM'
      'ORDEM_COLETA_ENTREGA')
    Left = 450
    Top = 230
    object qrBuscaOSOS_ID: TIntegerField
      FieldName = 'OS_ID'
    end
  end
