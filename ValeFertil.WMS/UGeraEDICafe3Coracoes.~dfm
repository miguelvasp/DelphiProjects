object FGeraEDICafe: TFGeraEDICafe
  Left = 258
  Top = 132
  Width = 860
  Height = 493
  ...
  object Panel1: TPanel
    ...
    object lbProgresso: TLabel
      ...
      Width = 126
      Height = 13
      Caption = 'Exportando informações ...'
      Visible = False
    end
    ...
    object Label5: TLabel
      ...
      Width = 138
      Height = 13
      Caption = 'Exportando  conhecimentos..'
      Visible = False
    end
    ...
    object RadioGroup1: TRadioGroup
      ...
      Width = 408
      Height = 47
      Caption = 'Selecione Layou a ser gerado'
      Columns = 3
      ItemIndex = 0
      Items.Strings = (
        'EDI DOCCOB'
    ...
    object CheckBox1: TCheckBox
      ...
      Width = 225
      Height = 17
      Caption = 'EDI DOCCOB considerar ICMS?'
      Checked = True
      State = cbChecked
      TabOrder = 9
    end
  ...
  object Q_PARAMETRO: TwwQuery
    ...
    SQL.Strings = (
      'SELECT PAR_RAZA,PAR_CNPJ FROM PARAMETRO'
  ...
  object Q_FAT: TwwQuery
    ...
    SessionName = 'Sec_BaseDados'
    SQL.Strings = (
      'SELECT A.*,B.IFAT_VCTO'
      'from FATURA A,FATURA_ITENS B'
      'where   A.FAT_Id = B.FAT_ID')
    ValidateWithMask = True
    Left = 140
    Top = 20
    object Q_FATFAT_ID: TAutoIncField
      FieldName = 'FAT_ID'
      Origin = 'NBFDADOS.FATURA.FAT_ID'
    end
    object Q_FATFAT_NUM: TIntegerField
      FieldName = 'FAT_NUM'
      Origin = 'NBFDADOS.FATURA.FAT_NUM'
    end
    object Q_FATCOND_PGTO_ID: TIntegerField
      FieldName = 'COND_PGTO_ID'
      Origin = 'NBFDADOS.FATURA.COND_PGTO_ID'
    end
    object Q_FATCLIN_ID: TIntegerField
      FieldName = 'CLIN_ID'
      Origin = 'NBFDADOS.FATURA.CLIN_ID'
    end
    object Q_FATFAT_VALOR: TFloatField
      FieldName = 'FAT_VALOR'
      Origin = 'NBFDADOS.FATURA.FAT_VALOR'
    end
    object Q_FATFAT_EMISSAO: TDateTimeField
      FieldName = 'FAT_EMISSAO'
      Origin = 'NBFDADOS.FATURA.FAT_EMISSAO'
    end
    object Q_FATFAT_TIPO: TStringField
      FieldName = 'FAT_TIPO'
      Origin = 'NBFDADOS.FATURA.FAT_TIPO'
      FixedChar = True
      Size = 1
    end
    object Q_FATIFAT_VCTO: TDateTimeField
      FieldName = 'IFAT_VCTO'
  ...
  object qrConhecimentos: TwwQuery
    DatabaseName = 'NbfDados'
    SessionName = 'Sec_BaseDados'
    SQL.Strings = (
      
        'SELECT   MANI_ID, VEIC_ID,  ORD_ID, ORD_CONH, ORD_DATA, ORD_VLR_' +
        'PEDAGIO, ORD_VLR_DESPACHO, ORD_VLR_SECCAT, ORD_VLR_FRETE, ORD_PE' +
        'SO_TOTAL, '
      
        '                      ORD_TOTALPREST, ORD_VLR_ICMS, ORD_ALIQ, OR' +
        'D_VLR_OUTROS, CLIN_ID, ord_redespacho, cfa_id, ORD_PAGO, CLIF_ID' +
        ', CTE_CHAVE, CTE_PROTOCOLO, e_complementar'
    ...
    object qrConhecimentosCTE_CHAVE: TMemoField
      FieldName = 'CTE_CHAVE'
      BlobType = ftMemo
    end
    object qrConhecimentosCTE_PROTOCOLO: TMemoField
      FieldName = 'CTE_PROTOCOLO'
      BlobType = ftMemo
    end
    object qrConhecimentose_complementar: TStringField
  ...
  object qrNotasORD: TwwQuery
    DatabaseName = 'NbfDados'
    SessionName = 'Sec_BaseDados'
    SQL.Strings = (
      'SELECT NFI_NUMERO, NFI_ENTREGA FROM NF'
      ''
      'WHERE ORD_ID = :ORD_ID')
    ValidateWithMask = True
    Left = 448
    ...
    object qrNotasORDNFI_NUMERO: TStringField
      FieldName = 'NFI_NUMERO'
      Origin = 'NBFDADOS.NF.NFI_NUMERO'
      FixedChar = True
      Size = 10
    end
    object qrNotasORDNFI_ENTREGA: TStringField
  ...
  object qrOcoren: TwwQuery
    ...
    SQL.Strings = (
      ...
      'AND A.CLIN_ID = :CLIN_ID'
      'AND CONVERT(CHAR(10), A.ORD_DATA, 112) >= :DATAI'
      'AND CONVERT(CHAR(10), A.ORD_DATA, 112) <= :DATAF')
    ValidateWithMask = True
    Left = 88
    Top = 146
    ParamData = <
    ...
    object qrOcorenORD_CONH: TStringField
      FieldName = 'ORD_CONH'
      Origin = 'NBFDADOS.ORDEM_COLETA_ENTREGA.ORD_CONH'
      FixedChar = True
      Size = 10
    end
    object qrOcorenORD_DATA: TDateTimeField
      FieldName = 'ORD_DATA'
      Origin = 'NBFDADOS.ORDEM_COLETA_ENTREGA.ORD_DATA'
    end
    object qrOcorenCLIN_CGCCPF: TStringField
      FieldName = 'CLIN_CGCCPF'
      Origin = 'NBFDADOS.CLIENTENBF.CLIN_CGCCPF'
      FixedChar = True
      Size = 15
    end
    object qrOcorenNFI_NUMERO: TStringField
      FieldName = 'NFI_NUMERO'
      Origin = 'NBFDADOS.NF.NFI_NUMERO'
      FixedChar = True
      Size = 10
