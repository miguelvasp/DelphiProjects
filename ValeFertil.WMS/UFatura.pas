...
begin
         If MessageDlg('Confirma a Impressão da(s) Fatura(s)?',MtConfirmation,[MbYes,
...
begin
   ...
   wwdbedit4.setfocus;
   Label3.caption := 'Relatório de Conhecimentos por Fatura'  ;
       ...
       IF ((wwdbedit4.text <> '') or
           (wwdbedit5.text <> '')) then begin
            ...
            IF (strtoint(wwdbedit4.text) >  strtoint(wwdbedit5.text)) then begin
               MessageDlg('Nº da Fatura inicial é maior do que a final !',mtWarning,[mbok],0);
               wwdbedit4.setfocus;
               abort;
            end ;

           //efetuamos a verificação dos valores dos conhecimentos da tabela OEC_AUX
           qrBuscaOS.Close;
           ...
           MessageDlg('Escolha um número de Fatura!',mtWarning,[mbok],0);
           wwdbedit4.setfocus;
       end ;
   end else begin
        ...
        IF ((wwdbedit4.text <> '') and
            ...
            IF (strtoint(wwdbedit4.text) >  strtoint(wwdbedit5.text)) then begin
             ...
             //criamos transação para evitar erros
             try
                 ...
                 begin
                     ...
                     MessageBox(Self.Handle, PChar('Aconteceu um erro ao efetuar sua solicitação:' +
                                                   #13 + e.message + #13 +
                                                   'Nenhum alteração foi efetuada!'),
           ...
           MessageDlg('Preencha os dois campos(de...até) com o Nº da Fatura !',mtWarning,[mbok],0);
           wwdbedit4.setfocus;
       end ;
