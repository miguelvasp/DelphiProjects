  ...
  object Panel3: TPanel
    ...
    object GRID: TwwDBGrid
      ...
      Selected.Strings = (
        ...
        'PROdesc'#9'38'#9'Descrição do Produto'
    ...
    object GridBATCH: TwwDBGrid
      ...
      Height = 208
      Selected.Strings = (
        'PRO_COD'#9'17'#9'Cód.Produto'#9'F'
        'PRO_DESC'#9'51'#9'Descrição'#9'F'
        'MARCADOR'#9'12'#9'Marcador'#9'F')
      IniAttributes.FileName = 'delphi32.ini'
    ...
    object Panel4: TPanel
      ...
      object Label36: TLabel
        ...
        Width = 177
        Height = 19
        Caption = 'Alteração Área/Posição'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clMaroon
        Font.Height = -16
        Font.Name = 'Arial'
