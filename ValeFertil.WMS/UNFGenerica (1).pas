...
begin
    ...
    If (Q_INFNCM.asstring = '') then begin
        MessageDlg('NCM é campo de Preechimento obrigatório !',mtWarning,[mbok],0);
        TabbedNotebook1.pageindex := 1   ;
    ...
    If (Q_INFPRO_DESC.asstring = '') then begin
        MessageDlg('Descrição é campo de Preechimento obrigatório !',mtWarning,[mbok],0);
        TabbedNotebook1.pageindex := 1   ;
    ...
    If (Q_INFUVEN_ID.asstring = '') then begin
        MessageDlg('Unidade é campo de Preechimento obrigatório !',mtWarning,[mbok],0);
        TabbedNotebook1.pageindex := 1   ;
