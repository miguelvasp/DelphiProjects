object frmEDIDiageo: TfrmEDIDiageo
  Left = 194
  Top = 117
  Width = 560
  Height = 352
  Caption = 'frmEDIDiageo'
  Color = clBtnFace
  ...
  object qrConhecimentos: TwwQuery
    ...
    SQL.Strings = (
        ...
        'SELECT  MANI_ID, VEIC_ID,    ORD_ID, ORD_CONH, ORD_DATA, ORD_VLR' +
        '_PEDAGIO, ORD_VLR_DESPACHO, ORD_VLR_SECCAT, ORD_VLR_FRETE, ORD_P' +
        'ESO_TOTAL, '
