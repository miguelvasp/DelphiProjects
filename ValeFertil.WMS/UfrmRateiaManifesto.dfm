object frmRateiaManifesto: TfrmRateiaManifesto
  Left = 222
  Top = 134
  BorderIcons = [biSystemMenu, biMaximize]
  BorderStyle = bsSingle
  Caption = 'Manifesto de Transporte'
  ClientHeight = 514
  ClientWidth = 784
  Color = clBtnFace
  ...
  object STP_RATEIO: TADOStoredProc
    Connection = FMenu.ADOConnection
    ProcedureName = 'RATEIA_MANIFESTO;1'
    Parameters = <
      item
        Name = '@MANI_ID'
  ...
  object qrMani: TADOQuery
    ...
    SQL.Strings = (
      'SELECT * FROM MANIFESTO_RATEIO'
      'where ch = :ch'
      'order by mani_id')
    Left = 368
    Top = 176
    object qrManiMANI_ID: TIntegerField
      DisplayLabel = 'Manifesto'
      DisplayWidth = 10
      FieldName = 'MANI_ID'
    end
    object qrManiDATA: TDateTimeField
      DisplayLabel = 'Data'
      DisplayWidth = 12
      FieldName = 'DATA'
      DisplayFormat = 'dd/mm/yyyy'
    end
    object qrManiCLIN_NOME: TStringField
      DisplayLabel = 'Cliente'
      DisplayWidth = 35
      FieldName = 'CLIN_NOME'
      Size = 30
    end
    object qrManiPESO: TFloatField
      DisplayLabel = 'Peso'
      DisplayWidth = 10
      FieldName = 'PESO'
      DisplayFormat = '###,###,##0.00'
    end
    object qrManiVALOR: TFloatField
      DisplayLabel = 'Valor'
      DisplayWidth = 10
      FieldName = 'VALOR'
      DisplayFormat = '###,###,##0.00'
    end
    object qrManiT: TStringField
      DisplayLabel = 'Tipo'
      DisplayWidth = 10
    ...
    object qrManiTIPO: TStringField
      DisplayLabel = 'Tipo'
      DisplayWidth = 1
      FieldName = 'TIPO'
      Visible = False
    ...
    object qrManiID: TAutoIncField
      DisplayWidth = 10
      FieldName = 'ID'
      ReadOnly = True
      Visible = False
    end
    object qrManiCH: TIntegerField
      DisplayWidth = 10
      FieldName = 'CH'
      Visible = False
    end
  ...
  object qrListaMani: TADOQuery
    ...
    SQL.Strings = (
        ...
        'SELECT DISTINCT  A.MANI_ID, A.MANI_ENT_COL, B.VLR_FRETE, A.MANI_' +
        'DATA'
      
        'FROM MANIFESTO A (NOLOCK) INNER JOIN PGTO_FRETE B (NOLOCK) ON A.' +
        'MANI_ID = B.MANI_ID'
      'WHERE CONVERT(CHAR(10), A.MANI_DATA, 112) >= :DT_I'
      'AND CONVERT(CHAR(10), A.MANI_DATA, 112) <= :DT_F')
    Left = 72
    Top = 176
    object qrListaManiMANI_ID: TAutoIncField
      FieldName = 'MANI_ID'
      ReadOnly = True
    end
    object qrListaManiMANI_ENT_COL: TStringField
      FieldName = 'MANI_ENT_COL'
      Size = 2
    end
    object qrListaManiVLR_FRETE: TFloatField
      FieldName = 'VLR_FRETE'
    end
    object qrListaManiMANI_DATA: TDateTimeField
      FieldName = 'MANI_DATA'
    end
  end
