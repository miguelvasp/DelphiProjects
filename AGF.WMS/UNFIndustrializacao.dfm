object FNFIndustrializacao: TFNFIndustrializacao
  Left = 298
  Top = 121
  Width = 799
  Height = 578
  ...
  BorderIcons = []
  Caption = 'Notas Fiscais de Industrialização'
  Color = clBtnFace
  ...
  object TabbedNotebook1: TTabbedNotebook
    ...
    object TTabPage
      ...
      object DBG_INFI: TwwDBGrid
        ...
        Selected.Strings = (
          'INF_ITEM'#9'3'#9'Item'
          'PRO_COD'#9'15'#9'Código'
          'PRO_DESC'#9'40'#9'Descrição'
          'INF_QTDE'#9'15'#9' Quantidade UV'
          'ESTQ_LOTE1'#9'10'#9'Lote 1'
          'ESTQ_LOTE1_QTDE'#9'15'#9'Qtde.Lote 1'
          'ESTQ_LOTE2'#9'10'#9'Lote 2'
          'ESTQ_LOTE2_QTDE'#9'15'#9'Qtde.Lote 2'
          ...
          'UVEN_DESC'#9'10'#9'UV'
          'INF_AICM'#9'7'#9'ICMS %'
          'PRO_ID_IND'#9'10'#9'PRO_ID_IND'
          'PRO_COD_IND'#9'16'#9'PRO_COD_IND')
  ...
  object Q_INF: TwwQuery
    ...
    object Q_INFPRO_ID_IND: TIntegerField
      FieldName = 'PRO_ID_IND'
      Origin = 'NBFDADOS.NF_ITENS.PRO_ID_IND'
    end
    object Q_INFPRO_COD_IND: TStringField
      FieldName = 'PRO_COD_IND'
      Origin = 'NBFDADOS.NF_ITENS.PRO_COD_IND'
      FixedChar = True
      Size = 16
    end
  end
  ...
  object UPD_NF: TUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      'NFI_REDESPACHO, '
      '   TRANS_ID, NFI_LOAD, NFI_SERIE, NFI_STATUS, BLOQUEIO)'
      'values'
