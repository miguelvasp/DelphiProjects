object frmNFS_Conhecimento: TfrmNFS_Conhecimento
  ...
  object Panel1: TPanel
    ...
    object Panel2: TPanel
      ...
      object Label8: TLabel
        ...
        Width = 354
        Height = 14
        Caption = 'Para gerar a fatura por favor selecione a condição de pagamento'
      end
      object cboCondPgto: TwwDBLookupCombo
        ...
        Selected.Strings = (
          ...
          'Num_Parcelas'#9'28'#9'Número de Parcelas'#9'F')
        LookupTable = Q_COND
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TabSheet1: TRzTabSheet
      Caption = 'OEs vinculadas a esta nota de serviços'
