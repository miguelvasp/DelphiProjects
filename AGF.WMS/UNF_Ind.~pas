...
procedure TFNF_Ind.SpeedButton3Click(Sender: TObject);
var
  NOTA : string ;
begin
...
procedure TFNF_Ind.FormCreate(Sender: TObject);
begin
...
procedure TFNF_Ind.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Q_TDOC.close ;
  Q_CLIN.close ;
  Q_CLIF.close  ;
...
procedure TFNF_Ind.Q_NFAfterPost(DataSet: TDataSet);
var
  STRNF : string ; {121212}
begin
...
procedure TFNF_Ind.Q_NFNewRecord(DataSet: TDataSet);
begin
...
procedure TFNF_Ind.FormPaint(Sender: TObject);
begin
   If Self.Tag = 0 Then
        Begin
             Self.Tag := 1;
...
procedure TFNF_Ind.DS_NFDataChange(Sender: TObject; Field: TField);
begin
...
procedure TFNF_Ind.BitBtn1Click(Sender: TObject);
begin
    Panel3.visible := true ;
...
procedure TFNF_Ind.wwDBLookupCombo5Exit(Sender: TObject);
begin
...
procedure TFNF_Ind.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then
     begin
       key := #0;
...
procedure TFNF_Ind.wwDBLookupCombo8Exit(Sender: TObject);
begin
   (Sender as TwwDBLookupCombo).Color := Clwindow ;      

end;

procedure TFNF_Ind.DBNavigator1Click(Sender: TObject; Button: TNavigateBtn);
begin
   if button in [nbInsert] then  begin
...
procedure TFNF_Ind.BitBtn2Click(Sender: TObject);
begin
       Q_AUX.close;
       Q_AUX.Sql.Clear;
...
procedure TFNF_Ind.SpeedButton2Click(Sender: TObject);
begin
    Panel3.visible := false ;
    Panel2.enabled := true ;
    Panel1.enabled := true ;
...
procedure TFNF_Ind.wwDBLookupCombo8Enter(Sender: TObject);
begin
   (Sender as TwwDBLookupCombo).Color := ClAqua;
end;

procedure TFNF_Ind.wwDBEdit17Enter(Sender: TObject);
begin
  (Sender as Tedit).Color := ClAqua;
end;

procedure TFNF_Ind.wwDBEdit17Exit(Sender: TObject);
begin
   (Sender as Tedit).Color := Clwindow ;
end;

procedure TFNF_Ind.Q_NFAfterDelete(DataSet: TDataSet);
var
  STRNF : string ; {121212}
begin
   STRNF := Q_NFNFI_CODI.asstring   ;
...
procedure TFNF_Ind.wwDBLookupCombo7Enter(Sender: TObject);
begin
 (Sender as TwwDBLookupCombo).Color := ClAqua;
end;

procedure TFNF_Ind.wwDBLookupCombo7Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow ;
...
procedure TFNF_Ind.wwDBLookupCombo5Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua  ;
end;

procedure TFNF_Ind.wwDBLookupCombo2Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow ;
...
procedure TFNF_Ind.wwDBLookupCombo2Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua  ;
end;

procedure TFNF_Ind.wwDBLookupCombo9Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBLookupCombo9Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow ;
...
procedure TFNF_Ind.wwDBLookupCombo6Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua   ;
  wwDBLookupCombo6.Selected.Text := 'CNPJCPF	15	CNPJCPF	F';
end;

procedure TFNF_Ind.wwDBLookupCombo6Exit(Sender: TObject);
begin
...
procedure TFNF_Ind.wwDBLookupCombo4Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua  ;
end;

procedure TFNF_Ind.wwDBLookupCombo4Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow ;
...
procedure TFNF_Ind.wwDBEdit4Enter(Sender: TObject);
begin
  (Sender as TwwDBedit).Color := Claqua  ;
end;

procedure TFNF_Ind.wwDBEdit4Exit(Sender: TObject);
begin
   ///GROUPBOX3.enabled := true ;
...
procedure TFNF_Ind.wwDBLookupCombo3Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBLookupCombo1Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBLookupCombo1Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow  ;
end;

procedure TFNF_Ind.wwDBLookupCombo3Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow  ;
...
procedure TFNF_Ind.wwDBComboBox4Exit(Sender: TObject);
begin
...
procedure TFNF_Ind.wwDBComboBox4Enter(Sender: TObject);
begin
    (Sender as TwwDBcombobox).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit5Enter(Sender: TObject);
begin
    (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit5Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.wwDBEdit1Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
  Q_NFNFI_DEST_CGC.EditMask := '' ;
   if wwDBComboBox4.text = 'Física' then
...
procedure TFNF_Ind.wwDBEdit1Exit(Sender: TObject);
Var
...
procedure TFNF_Ind.wwDBEdit2Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit3Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit6Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit7Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit12Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit8Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit9Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit10Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit2Exit(Sender: TObject);
begin
 (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.wwDBEdit3Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.wwDBEdit6Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
...
procedure TFNF_Ind.wwDBEdit7Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.wwDBEdit12Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.wwDBEdit8Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.wwDBEdit9Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.wwDBEdit10Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.Q_INFAfterDelete(DataSet: TDataSet);
///var
//StrITEM : string ;
begin
...
procedure TFNF_Ind.Q_INFAfterPost(DataSet: TDataSet);
var
StrITEM : string ;
begin
...
procedure TFNF_Ind.DBLC_INF_PRODExit(Sender: TObject);
VAR AUX : string;
begin
...
procedure TFNF_Ind.Q_INFNewRecord(DataSet: TDataSet);
begin
...
procedure TFNF_Ind.TabbedNotebook1Click(Sender: TObject);
var
     STRNF : string ;
begin
...
procedure TFNF_Ind.wwDBEdit13Enter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit13Exit(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Clwindow ;
...
procedure TFNF_Ind.DBG_INFIColExit(Sender: TObject);
begin
...
procedure TFNF_Ind.wwDBEdit14Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBE_NFI_PLACEnter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBE_NFI_DSAIEnter(Sender: TObject);
begin
    (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBE_NFI_MARCEnter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBE_NFI_QTDEEnter(Sender: TObject);
begin
     (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBE_NFI_ESPEEnter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBE_NFI_PLIQEnter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBE_NFI_PBRUEnter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBLC_NFI_UFVEEnter(Sender: TObject);
begin
  (Sender as TwwDBlookupcombo).Color := Claqua ;
end;

procedure TFNF_Ind.DBCB_NFI_TFREEnter(Sender: TObject);
begin
   (Sender as TwwDBcombobox).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit14Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBE_NFI_PLACExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBE_NFI_DSAIExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBE_NFI_MARCExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBE_NFI_QTDEExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBE_NFI_ESPEExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBE_NFI_PLIQExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBE_NFI_PBRUExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBLC_NFI_UFVEExit(Sender: TObject);
begin
  (Sender as TwwDBlookupcombo).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBCB_NFI_TFREExit(Sender: TObject);
begin
 (Sender as TwwDBcombobox).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBEdit5Exit(Sender: TObject);
begin
    (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBEdit5Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNF_Ind.DBEdit3Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNF_Ind.DBEdit3Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBEdit2Enter(Sender: TObject);
begin
       (Sender as TDBEdit).Color := Claqua;
end;

procedure TFNF_Ind.DBEdit2Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBEdit1Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBEdit1Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.BitBtn3Click(Sender: TObject);
var
NFCOD : string ;
begin
...
procedure TFNF_Ind.DBEdit9Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.DBEdit14Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNF_Ind.DBEdit14Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ; 
end;

procedure TFNF_Ind.DBEdit9Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNF_Ind.DBEdit11Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNF_Ind.DBEdit11Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ; 
end;

procedure TFNF_Ind.DBEdit10Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.DBEdit10Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNF_Ind.DBCB_CFA_TIPIEnter(Sender: TObject);
begin
  (Sender as Twwdbcombobox).Color := Claqua ; 
end;

procedure TFNF_Ind.DBCB_CFA_TIPIExit(Sender: TObject);
begin
   (Sender as Twwdbcombobox).Color := Clwindow  ;
end;

procedure TFNF_Ind.wwDBLookupCombo10Enter(Sender: TObject);
begin
    (Sender as TwwDBLookupCombo).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBLookupCombo10Exit(Sender: TObject);
begin
     (Sender as TwwDBLookupCombo).Color := CLWINDOW ;
end;

procedure TFNF_Ind.wwDBEdit11Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBEdit11Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNF_Ind.FormShow(Sender: TObject);
begin
  IF RETORNOSIMB = '' then begin
...
procedure TFNF_Ind.Q_NFBeforePost(DataSet: TDataSet);
begin
...
procedure TFNF_Ind.Q_NFBeforeScroll(DataSet: TDataSet);
begin
     IF ((MANIFESTONF = '*') or
        (PESQUISANF = '*') or
        (PESQUISANF2 = '*') or
...
procedure TFNF_Ind.Q_NFBeforeEdit(DataSet: TDataSet);
begin
  IF ((MANIFESTONF = '*') or
      (PESQUISANF  = '*') or
      (PESQUISANF2 = '*') or
...
procedure TFNF_Ind.Q_NFBeforeDelete(DataSet: TDataSet);
begin
  IF ((MANIFESTONF = '*') or
   (PESQUISANF = '*') or
    (PESQUISANF2 = '*') or
...
procedure TFNF_Ind.Q_INFBeforeScroll(DataSet: TDataSet);
begin
     IF ((MANIFESTONF = '*') or
     (PESQUISANF = '*') or
      (PESQUISANF2 = '*') or
...
procedure TFNF_Ind.Q_INFBeforeEdit(DataSet: TDataSet);
begin
  IF ((MANIFESTONF = '*') or
      (PESQUISANF = '*') or
      (PESQUISANF2 = '*') or
...
procedure TFNF_Ind.Q_INFBeforeDelete(DataSet: TDataSet);
begin
      IF ((MANIFESTONF = '*') or
      (PESQUISANF = '*') or
       (PESQUISANF2 = '*') or
...
procedure TFNF_Ind.Q_INFBeforePost(DataSet: TDataSet);
begin
...
procedure TFNF_Ind.DBMemo2Enter(Sender: TObject);
begin
   (Sender as TDBmemo).Color := Claqua;
   Fnf.KeyPreview:=false;
end;

procedure TFNF_Ind.DBMemo2Exit(Sender: TObject);
begin
     (Sender as TDBmemo).Color := Clwindow;
     Fnf.KeyPreview:=true;
end;

procedure TFNF_Ind.SpeedButton5Click(Sender: TObject);
begin
...
procedure TFNF_Ind.wwDBComboBox1Enter(Sender: TObject);
begin
   (Sender as TwwDBcombobox).Color := Claqua ;
end;

procedure TFNF_Ind.wwDBComboBox1Exit(Sender: TObject);
begin
    (Sender as TwwDBcombobox).Color := Clwindow  ;
...
procedure TFNF_Ind.wwDBLookupCombo16Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua  ;
end;

procedure TFNF_Ind.wwDBLookupCombo16Exit(Sender: TObject);
begin
...
procedure TFNF_Ind.SpeedButton1Click(Sender: TObject);
Const Brancos = '                                                                                                                                                                             ' ;
var
    STRSTRING : string ;
    F         :  TextFile ;
...
function TFNF_Ind.MUDALETR(LETRA: string): string;
var
  NOVALETRA         : string;
  s                 : string;
  M_DataLEN, i      : Integer;
...
procedure TFNF_Ind.Q_NFBeforeInsert(DataSet: TDataSet);
begin
...
procedure TFNF_Ind.SpeedButton4Click(Sender: TObject);
begin
       Q_NF55.open ;
...
procedure TFNF_Ind.BitBtn5Click(Sender: TObject);
begin
      TabbedNotebook1.enabled := true ;
      Panel2.enabled := true;
...
procedure TFNF_Ind.BitBtn4Click(Sender: TObject);
begin
...
procedure TFNF_Ind.wwDBEdit16Exit(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Clwindow ;
...
procedure TFNF_Ind.wwDBEdit16Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;

end;

procedure TFNF_Ind.ds1DataChange(Sender: TObject; Field: TField);
begin
        LB.Caption := Q_CLIFdestCLIF_RAZA.Value;
end;

procedure TFNF_Ind.wwDBLookupCombo6Change(Sender: TObject);
begin
