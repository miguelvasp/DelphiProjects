...
begin
   if MessageBox(Self.Handle, 'Deseja emitir os documentos acima listados? Os dados da OE serão confirmados e não poderá mais alterar as informações.', 'Confirmação', MB_YESNO) = 6 then begin
   ...
   //após executar altera o valor do CTe
