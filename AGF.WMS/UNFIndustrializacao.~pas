...
type
  TFNFIndustrializacao = class(TForm)
    ...
    Q_INFPRO_ID_IND: TIntegerField;
    Q_INFPRO_COD_IND: TStringField;
    Q_PROD2: TwwQuery;
...
var
  FNFIndustrializacao: TFNFIndustrializacao;
...
procedure TFNFIndustrializacao.SpeedButton3Click(Sender: TObject);
var
  NOTA : string ;
begin
...
procedure TFNFIndustrializacao.FormCreate(Sender: TObject);
begin
...
procedure TFNFIndustrializacao.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  Q_TDOC.close ;
  Q_CLIN.close ;
  Q_CLIF.close  ;
...
procedure TFNFIndustrializacao.Q_NFAfterPost(DataSet: TDataSet);
var
  STRNF : string ; {121212}
begin
...
procedure TFNFIndustrializacao.Q_NFNewRecord(DataSet: TDataSet);
begin
...
procedure TFNFIndustrializacao.FormPaint(Sender: TObject);
begin
   If Self.Tag = 0 Then
        Begin
             Self.Tag := 1;
             ...
             Try
                Begin
                     ...
                     FNFIndustrializacao.Q_NF.Open;


                     FAbTabelas.Gauge1.Progress            := 2;
                     FNFIndustrializacao.Q_INF.Open;

                 

                     FAbTabelas.Gauge1.Progress            := 3;
                     FNFIndustrializacao.Q_MUNI.Open;

                     FAbTabelas.Gauge1.Progress            := 4;
                     FNFIndustrializacao.Q_TRANS2.Open;
...
procedure TFNFIndustrializacao.DS_NFDataChange(Sender: TObject; Field: TField);
begin
...
procedure TFNFIndustrializacao.BitBtn1Click(Sender: TObject);
begin
    Panel3.visible := true ;
...
procedure TFNFIndustrializacao.wwDBLookupCombo5Exit(Sender: TObject);
begin
...
procedure TFNFIndustrializacao.FormKeyPress(Sender: TObject; var Key: Char);
begin
  if key = #13 then
     begin
       key := #0;
...
procedure TFNFIndustrializacao.wwDBLookupCombo8Exit(Sender: TObject);
begin
   (Sender as TwwDBLookupCombo).Color := Clwindow ;      

end;

procedure TFNFIndustrializacao.DBNavigator1Click(Sender: TObject; Button: TNavigateBtn);
begin
   if button in [nbInsert] then  begin
...
procedure TFNFIndustrializacao.BitBtn2Click(Sender: TObject);
begin
       Q_AUX.close;
       Q_AUX.Sql.Clear;
...
procedure TFNFIndustrializacao.SpeedButton2Click(Sender: TObject);
begin
    Panel3.visible := false ;
    Panel2.enabled := true ;
    Panel1.enabled := true ;
...
procedure TFNFIndustrializacao.wwDBLookupCombo8Enter(Sender: TObject);
begin
   (Sender as TwwDBLookupCombo).Color := ClAqua;
end;

procedure TFNFIndustrializacao.wwDBEdit17Enter(Sender: TObject);
begin
  (Sender as Tedit).Color := ClAqua;
end;

procedure TFNFIndustrializacao.wwDBEdit17Exit(Sender: TObject);
begin
   (Sender as Tedit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.Q_NFAfterDelete(DataSet: TDataSet);
var
  STRNF : string ; {121212}
begin
   STRNF := Q_NFNFI_CODI.asstring   ;
...
procedure TFNFIndustrializacao.wwDBLookupCombo7Enter(Sender: TObject);
begin
 (Sender as TwwDBLookupCombo).Color := ClAqua;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo7Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow ;
...
procedure TFNFIndustrializacao.wwDBLookupCombo5Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua  ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo2Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow ;
...
procedure TFNFIndustrializacao.wwDBLookupCombo2Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua  ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo9Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo9Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow ;
...
procedure TFNFIndustrializacao.wwDBLookupCombo6Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua   ;
  wwDBLookupCombo6.Selected.Text := 'CNPJCPF	15	CNPJCPF	F';
end;

procedure TFNFIndustrializacao.wwDBLookupCombo6Exit(Sender: TObject);
begin
...
procedure TFNFIndustrializacao.wwDBLookupCombo4Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua  ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo4Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow ;
...
procedure TFNFIndustrializacao.wwDBEdit4Enter(Sender: TObject);
begin
  (Sender as TwwDBedit).Color := Claqua  ;
end;

procedure TFNFIndustrializacao.wwDBEdit4Exit(Sender: TObject);
begin
   ///GROUPBOX3.enabled := true ;
...
procedure TFNFIndustrializacao.wwDBLookupCombo3Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo1Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo1Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo3Exit(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Clwindow  ;
...
procedure TFNFIndustrializacao.wwDBComboBox4Exit(Sender: TObject);
begin
...
procedure TFNFIndustrializacao.wwDBComboBox4Enter(Sender: TObject);
begin
    (Sender as TwwDBcombobox).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit5Enter(Sender: TObject);
begin
    (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit5Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.wwDBEdit1Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
  Q_NFNFI_DEST_CGC.EditMask := '' ;
   if wwDBComboBox4.text = 'Física' then
...
procedure TFNFIndustrializacao.wwDBEdit1Exit(Sender: TObject);
Var
...
procedure TFNFIndustrializacao.wwDBEdit2Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit3Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit6Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit7Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit12Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit8Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit9Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit10Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit2Exit(Sender: TObject);
begin
 (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.wwDBEdit3Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.wwDBEdit6Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
...
procedure TFNFIndustrializacao.wwDBEdit7Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.wwDBEdit12Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.wwDBEdit8Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.wwDBEdit9Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.wwDBEdit10Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.Q_INFAfterDelete(DataSet: TDataSet);
///var
//StrITEM : string ;
begin
...
procedure TFNFIndustrializacao.Q_INFAfterPost(DataSet: TDataSet);
var
StrITEM : string ;
begin
...
procedure TFNFIndustrializacao.DBLC_INF_PRODExit(Sender: TObject);
VAR AUX : string;
begin
...
procedure TFNFIndustrializacao.Q_INFNewRecord(DataSet: TDataSet);
begin
...
procedure TFNFIndustrializacao.TabbedNotebook1Click(Sender: TObject);
var
     STRNF : string ;
begin
...
procedure TFNFIndustrializacao.wwDBEdit13Enter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit13Exit(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Clwindow ;
...
procedure TFNFIndustrializacao.DBG_INFIColExit(Sender: TObject);
begin
...
procedure TFNFIndustrializacao.wwDBEdit14Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBE_NFI_PLACEnter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBE_NFI_DSAIEnter(Sender: TObject);
begin
    (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBE_NFI_MARCEnter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBE_NFI_QTDEEnter(Sender: TObject);
begin
     (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBE_NFI_ESPEEnter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBE_NFI_PLIQEnter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBE_NFI_PBRUEnter(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBLC_NFI_UFVEEnter(Sender: TObject);
begin
  (Sender as TwwDBlookupcombo).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBCB_NFI_TFREEnter(Sender: TObject);
begin
   (Sender as TwwDBcombobox).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit14Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBE_NFI_PLACExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBE_NFI_DSAIExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBE_NFI_MARCExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBE_NFI_QTDEExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBE_NFI_ESPEExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBE_NFI_PLIQExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBE_NFI_PBRUExit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBLC_NFI_UFVEExit(Sender: TObject);
begin
  (Sender as TwwDBlookupcombo).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBCB_NFI_TFREExit(Sender: TObject);
begin
 (Sender as TwwDBcombobox).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBEdit5Exit(Sender: TObject);
begin
    (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBEdit5Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNFIndustrializacao.DBEdit3Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNFIndustrializacao.DBEdit3Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBEdit2Enter(Sender: TObject);
begin
       (Sender as TDBEdit).Color := Claqua;
end;

procedure TFNFIndustrializacao.DBEdit2Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBEdit1Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBEdit1Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.BitBtn3Click(Sender: TObject);
var
NFCOD : string ;
begin
...
procedure TFNFIndustrializacao.DBEdit9Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.DBEdit14Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNFIndustrializacao.DBEdit14Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ; 
end;

procedure TFNFIndustrializacao.DBEdit9Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.DBEdit11Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNFIndustrializacao.DBEdit11Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow  ; 
end;

procedure TFNFIndustrializacao.DBEdit10Exit(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.DBEdit10Enter(Sender: TObject);
begin
  (Sender as TDBEdit).Color := Claqua ; 
end;

procedure TFNFIndustrializacao.DBCB_CFA_TIPIEnter(Sender: TObject);
begin
  (Sender as Twwdbcombobox).Color := Claqua ; 
end;

procedure TFNFIndustrializacao.DBCB_CFA_TIPIExit(Sender: TObject);
begin
   (Sender as Twwdbcombobox).Color := Clwindow  ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo10Enter(Sender: TObject);
begin
    (Sender as TwwDBLookupCombo).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo10Exit(Sender: TObject);
begin
     (Sender as TwwDBLookupCombo).Color := CLWINDOW ;
end;

procedure TFNFIndustrializacao.wwDBEdit11Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBEdit11Exit(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Clwindow ;
end;

procedure TFNFIndustrializacao.FormShow(Sender: TObject);
begin
  IF RETORNOSIMB = '' then begin
...
procedure TFNFIndustrializacao.Q_NFBeforePost(DataSet: TDataSet);
begin
...
procedure TFNFIndustrializacao.Q_NFBeforeScroll(DataSet: TDataSet);
begin
     IF ((MANIFESTONF = '*') or
        (PESQUISANF = '*') or
        (PESQUISANF2 = '*') or
...
procedure TFNFIndustrializacao.Q_NFBeforeEdit(DataSet: TDataSet);
begin
  IF ((MANIFESTONF = '*') or
      (PESQUISANF  = '*') or
      (PESQUISANF2 = '*') or
...
procedure TFNFIndustrializacao.Q_NFBeforeDelete(DataSet: TDataSet);
begin
  IF ((MANIFESTONF = '*') or
   (PESQUISANF = '*') or
    (PESQUISANF2 = '*') or
...
procedure TFNFIndustrializacao.Q_INFBeforeScroll(DataSet: TDataSet);
begin
     IF ((MANIFESTONF = '*') or
     (PESQUISANF = '*') or
      (PESQUISANF2 = '*') or
...
procedure TFNFIndustrializacao.Q_INFBeforeEdit(DataSet: TDataSet);
begin
  IF ((MANIFESTONF = '*') or
      (PESQUISANF = '*') or
      (PESQUISANF2 = '*') or
...
procedure TFNFIndustrializacao.Q_INFBeforeDelete(DataSet: TDataSet);
begin
      IF ((MANIFESTONF = '*') or
      (PESQUISANF = '*') or
       (PESQUISANF2 = '*') or
...
procedure TFNFIndustrializacao.Q_INFBeforePost(DataSet: TDataSet);
begin
...
procedure TFNFIndustrializacao.DBMemo2Enter(Sender: TObject);
begin
   (Sender as TDBmemo).Color := Claqua;
      FNFIndustrializacao.KeyPreview:=false;
end;

procedure TFNFIndustrializacao.DBMemo2Exit(Sender: TObject);
begin
     (Sender as TDBmemo).Color := Clwindow;
     FNFIndustrializacao.KeyPreview:=true;
end;

procedure TFNFIndustrializacao.SpeedButton5Click(Sender: TObject);
begin
...
procedure TFNFIndustrializacao.wwDBComboBox1Enter(Sender: TObject);
begin
   (Sender as TwwDBcombobox).Color := Claqua ;
end;

procedure TFNFIndustrializacao.wwDBComboBox1Exit(Sender: TObject);
begin
    (Sender as TwwDBcombobox).Color := Clwindow  ;
...
procedure TFNFIndustrializacao.wwDBLookupCombo16Enter(Sender: TObject);
begin
  (Sender as TwwDBLookupCombo).Color := Claqua  ;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo16Exit(Sender: TObject);
begin
...
procedure TFNFIndustrializacao.SpeedButton1Click(Sender: TObject);
Const Brancos = '                                                                                                                                                                             ' ;
var
    STRSTRING : string ;
    F         :  TextFile ;
...
function TFNFIndustrializacao.MUDALETR(LETRA: string): string;
var
  NOVALETRA         : string;
  s                 : string;
  M_DataLEN, i      : Integer;
...
procedure TFNFIndustrializacao.Q_NFBeforeInsert(DataSet: TDataSet);
begin
...
procedure TFNFIndustrializacao.SpeedButton4Click(Sender: TObject);
begin
       Q_NF55.open ;
...
procedure TFNFIndustrializacao.BitBtn5Click(Sender: TObject);
begin
      TabbedNotebook1.enabled := true ;
      Panel2.enabled := true;
...
procedure TFNFIndustrializacao.BitBtn4Click(Sender: TObject);
begin
...
procedure TFNFIndustrializacao.wwDBEdit16Exit(Sender: TObject);
begin
   (Sender as TwwDBEdit).Color := Clwindow ;
...
procedure TFNFIndustrializacao.wwDBEdit16Enter(Sender: TObject);
begin
  (Sender as TwwDBEdit).Color := Claqua ;

end;

procedure TFNFIndustrializacao.ds1DataChange(Sender: TObject; Field: TField);
begin
        LB.Caption := Q_CLIFdestCLIF_RAZA.Value;
end;

procedure TFNFIndustrializacao.wwDBLookupCombo6Change(Sender: TObject);
begin
