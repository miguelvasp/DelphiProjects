...
begin
       ...
       totalPalets := Int( (Q_RMPMRP_QTDE.AsInteger / Q_PRODQTDE_UVUE.AsFloat) / Pallet_Qtde );
      ...
      if achei then
       ...
       SALDO :=  Q_RMPMRP_QTDE.asfloat - (CONTA_PALLET * (Pallet_Qtde  * Q_PRODQTDE_UVUE.AsFloat));

       //informa UE
       int_Aux := (int(CONTA_PALLET) * (Pallet_Qtde  * Q_PRODQTDE_UVUE.AsFloat))/ Q_PRODQTDE_UVUE.AsFloat;
    ...
    //   QRLabel22.Caption := FormatFloat('0', (CONTA_PALLET * (Pallet_Qtde  * Q_PRODQTDE_UVUE.AsInteger)));
       ...
       if saldo > 0 then begin
           //SALDO EM UE
           QRLabel22.Caption := FormatFloat('###,##0.000', SALDO / Q_PRODQTDE_UVUE.AsFloat);
           QRLabel39.Caption := lbun.Caption;
           F_UE := F_UE + SALDO / Q_PRODQTDE_UVUE.AsFloat ;
           //SALDO EM UV
