object FNF: TFNF
  ...
  object TabbedNotebook1: TTabbedNotebook
    ...
    object TTabPage
      ...
      object DBG_INFI: TwwDBGrid
        ...
        Height = 401
        Selected.Strings = (
          'INF_ITEM'#9'3'#9'Item'#9#9
          'PRO_COD'#9'15'#9'Código'#9#9
          'PRO_DESC'#9'40'#9'Descrição'#9#9
          'INF_QTDE'#9'15'#9' Quantidade UV'#9#9
          'ESTQ_LOTE1'#9'10'#9'Lote 1'#9#9
          'ESTQ_LOTE1_QTDE'#9'15'#9'Qtde.Lote 1'#9#9
          'ESTQ_LOTE2'#9'10'#9'Lote 2'#9#9
          'ESTQ_LOTE2_QTDE'#9'15'#9'Qtde.Lote 2'#9#9
          'INF_PUNI'#9'10'#9'Preço Unit.'#9#9
          'INF_AIPI'#9'5'#9'% Ipi'#9#9
          'INF_VIPI'#9'9'#9'   Valor IPI'#9#9
          'INF_TOTA'#9'11'#9'  Valor Total'#9#9
          'UVEN_DESC'#9'10'#9'UV'#9#9
          'INF_AICM'#9'7'#9'ICMS %'#9#9
          'rastro_dfab'#9'18'#9'Fabricação'#9#9
          'rastro_dvenc'#9'18'#9'Vencimento'#9#9
          'rastro_nlote'#9'40'#9'Lote'#9#9
          'rastro_qlote'#9'10'#9'Qtd Lote'#9#9)
  ...
  object Panel11: TPanel
    ...
    object Panel12: TPanel
      ...
      object Label49: TLabel
        ...
        Width = 343
        Height = 19
        Caption = 'Nota sem Redução de ICMS, escolha o CFOP'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -16
        Font.Name = 'Arial'
      ...
      object wwDBLookupCombo11: TwwDBLookupCombo
        ...
        DropDownAlignment = taLeftJustify
        Selected.Strings = (
          'CFA_CODI'#9'4'#9'Código'#9'F'
          'CFA_DCFO'#9'40'#9'Descrição'#9'F'
  ...
  object Q_INF: TwwQuery
    ...
    object Q_INFrastro_dfab: TDateTimeField
      DisplayLabel = 'Fabricação'
      DisplayWidth = 18
      FieldName = 'rastro_dfab'
      Origin = 'NBFDADOS.NF_ITENS.rastro_dfab'
    end
    object Q_INFrastro_dvenc: TDateTimeField
      DisplayLabel = 'Vencimento'
      DisplayWidth = 18
      FieldName = 'rastro_dvenc'
      Origin = 'NBFDADOS.NF_ITENS.rastro_dvenc'
    end
    object Q_INFrastro_nlote: TStringField
      DisplayLabel = 'Lote'
      DisplayWidth = 40
      FieldName = 'rastro_nlote'
      Origin = 'NBFDADOS.NF_ITENS.rastro_nlote'
      FixedChar = True
      Size = 250
    end
    object Q_INFrastro_qlote: TFloatField
      DisplayLabel = 'Qtd Lote'
      DisplayWidth = 10
      FieldName = 'rastro_qlote'
      Origin = 'NBFDADOS.NF_ITENS.rastro_qlote'
    end
  ...
  object UPD_INF: TUpdateSQL
    ...
    InsertSQL.Strings = (
      ...
      ':ESTQ_LOTE2, '
      '   :ESTQ_LOTE2_QTDE, :INF_CST, :rastro_nlote'
      '      ,:rastro_qlote'
      '      ,:rastro_dfab'
      '      ,:rastro_dvenc)')
    DeleteSQL.Strings = (
  ...
  object Q_FAT60: TwwQuery
    ...
    SQL.Strings = (
      ...
      #9' WHEN  CFA_TICM ='#39'4'#39' THEN '#39'ISENTO OU NÃO TRIBUTADO'#39
      #9' WHEN  CFA_TICM ='#39'5'#39' THEN '#39'COM SUSPENSÃO OU DIFERIMENTO'#39
