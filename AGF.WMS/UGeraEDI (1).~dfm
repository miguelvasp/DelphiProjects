object FGeraEDI: TFGeraEDI
  ...
  object qrConhecimentos: TwwQuery
    ...
    SQL.Strings = (
        ...
        'SELECT     ORD_ID, ORD_CONH, ORD_DATA, ORD_VLR_PEDAGIO, ORD_VLR_' +
        'DESPACHO, ORD_VLR_SECCAT, ORD_VLR_FRETE, ORD_PESO_TOTAL, '
      
        '                      ORD_TOTALPREST, VEIC_ID, MANI_ID,  ORD_VLR' +
        '_ICMS, ORD_ALIQ, ORD_VLR_OUTROS, CLIN_ID, ord_redespacho, cfa_id' +
        ', ORD_PAGO, CLIF_ID, CTE_CHAVE, CTE_PROTOCOLO'
