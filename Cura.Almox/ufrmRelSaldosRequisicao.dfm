object frmRelSaldosRequisicao: TfrmRelSaldosRequisicao
  Left = 192
  Top = 124
  Width = 1177
  Height = 480
  Caption = 'frmRelSaldosRequisicao'
  Color = clBtnFace
  ...
  object QuickRep1: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRLabel1: TQRLabel
        ...
        AutoSize = False
        AutoStretch = False
        Caption = 'Relatório de Requisição de Materiais'
        Color = clWhite
  ...
  object qrBusca: TADOQuery
    ...
    SQL.Strings = (
      ...
      #9'I.SALDO,'
      #9'I.STATUS ,'
      #9'CC.CC_Desc, '#39'emergencia     '#39' tipo'
    ...
    object qrBuscaSALDO: TFloatField
      DisplayLabel = 'Saldo'
      DisplayWidth = 7
      FieldName = 'SALDO'
    end
