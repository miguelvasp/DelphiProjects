...
begin
 ...
 // end;
  ...
  Excel.Cells[Linha, 8] := 'Valor Reposição Unitário';
  Excel.Cells[Linha, 9] := 'Valor total Reposição';
  Excel.Cells[Linha, 10] := 'Valor Custo Médio Unitário';
   Excel.Cells[Linha, 11] := 'Valor total Custo Médio';
  dsExcel.DataSet.First;
