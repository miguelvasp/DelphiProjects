...
uses
  ...
  wwdbedit, Db, Wwdatsrc, DBTables, Wwquery, wwstorep, DBCtrls, ADODB;
...
implementation
uses  UNT_SENHA, URelKardexSint, URelKardex, UMenu; //URelKardexSint, URelKardex;
{$R *.DFM}
