unit ufrmRelRecebimentoAnalitico;

interface

uses
  Windows, Messages, SysUtils, Classes, Graphics, Controls, Forms, Dialogs,
  StdCtrls, QuickRpt, Qrctrls, ExtCtrls, Db, DBTables, Wwquery, Wwdatsrc;

type
  TfrmRelRecebimentoAnalitico = class(TForm)
...
var
  frmRelRecebimentoAnalitico: TfrmRelRecebimentoAnalitico;
  TOTLIQ : real;
  TOTPAG : real;
  TOTSAL : real;
  TOTLIQF : real;
...
procedure TfrmRelRecebimentoAnalitico.QRLabel17Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',totliq);
end;

procedure TfrmRelRecebimentoAnalitico.QRLabel18Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',totpag);
end;

procedure TfrmRelRecebimentoAnalitico.QRLabel19Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',totsal);
end;

procedure TfrmRelRecebimentoAnalitico.QRBand3AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
...
procedure TfrmRelRecebimentoAnalitico.RelRecebBeforePrint(Sender: TCustomQuickRep;
  var PrintReport: Boolean);
var
filtro : string;
begin
...
procedure TfrmRelRecebimentoAnalitico.QRLabel22Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',TOTLIQF);
end;

procedure TfrmRelRecebimentoAnalitico.QRLabel23Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',TOTPAGF);
end;

procedure TfrmRelRecebimentoAnalitico.QRLabel24Print(sender: TObject;
  var Value: String);
begin
   Value := formatfloat('###,###,###,##0.00',TOTSALF);
end;

procedure TfrmRelRecebimentoAnalitico.QRLabel20Print(sender: TObject;
  var Value: String);
begin
   VALUE := FMenu.FUsuario;
end;

procedure TfrmRelRecebimentoAnalitico.QRLabel2Print(sender: TObject; var Value: String);
begin
   if TIPO = 0 then
...
procedure TfrmRelRecebimentoAnalitico.QRLabel9Print(sender: TObject; var Value: String);
begin
   if rTipo = 0 then
...
procedure TfrmRelRecebimentoAnalitico.QRBand4BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
{   if rTipo = 3 then
   begin
...
procedure TfrmRelRecebimentoAnalitico.QRGroup2BeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin
...
procedure TfrmRelRecebimentoAnalitico.QRGroup2AfterPrint(Sender: TQRCustomBand;
  BandPrinted: Boolean);
begin
   if rTipo <> 3 then
   begin
...
procedure TfrmRelRecebimentoAnalitico.QRDBText9Print(sender: TObject; var Value: String);
begin
   if rTipo = 2 then
...
procedure TfrmRelRecebimentoAnalitico.FormClose(Sender: TObject;
...
begin
   ...
   Action := caFree;
   frmRelRecebimentoAnalitico := nil;
end;

procedure TfrmRelRecebimentoAnalitico.FormCreate(Sender: TObject);
...
begin
   ...
   Q_RECE.SQL.Add('B.CLI_RAZA, A.REC_CGER, D.CON_DESC, ');
