...
uses
  ...
  gtQRXport, gtQRXport_Doc, gtQRXport_PDF, StdCtrls;
...
type
  TFRelReq = class(TForm)
    ...
    Q_ReqUsuarioSolicitacao: TStringField;
    QRLabel5: TQRLabel;
    QRLabel22: TQRLabel;
    QRDBText2: TQRDBText;
    QRLabel23: TQRLabel;
    ...
    QRLabel25: TQRLabel;
    Q_ReqObservacaoSolicitacao: TStringField;
    QRLabel3: TQRLabel;
    lbTipoReq: TQRLabel;
    lbMotivo: TQRLabel;
    QRLabel27: TQRLabel;
    Q_ReqTipoSolicitacao: TStringField;
    Q_ReqMotivoSolicitacao: TStringField;
    ...
    procedure QRGroup1AfterPrint(Sender: TQRCustomBand;
      BandPrinted: Boolean);
    procedure Q_ReqAfterOpen(DataSet: TDataSet);
...
procedure TFRelReq.Q_ReqAfterOpen(DataSet: TDataSet);
begin
   Q_REQ_ITEM.CLOSE;
...
procedure TFRelReq.TitleBeforePrint(Sender: TQRCustomBand;
  var PrintBand: Boolean);
begin

  if  Q_ReqTipoSolicitacao.AsString = 'U' then
        lbTipoReq.Caption := 'Urgente';
  if  Q_ReqTipoSolicitacao.AsString = 'N' then
        lbTipoReq.Caption := 'Normal';
  lbMotivo.Caption := '';
  lbMotivo.Caption := Q_ReqMotivoSolicitacao.AsString;
