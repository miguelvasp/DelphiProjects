object FpesqReceb: TFpesqReceb
  Left = 627
  Top = 162
  AutoSize = True
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Pesquisa Recebimentos'
  ClientHeight = 530
  ClientWidth = 792
  Color = clBtnFace
  ...
  object Panel3: TPanel
    ...
    object bt_Tod: TSpeedButton
      Left = 656
      Top = 96
      Width = 60
      Height = 27
      Cursor = crHandPoint
      Hint = 'Marca os títulos para o Fluxo de Caixa'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'Arial'
    ...
    object bt_Nem: TSpeedButton
      ...
      Height = 27
      Cursor = crHandPoint
      Hint = 'Desmarca os títulos para Fluxo de Caixa'
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlack
      Font.Height = -11
      Font.Name = 'Arial'
    ...
    object DBLC_REC_RAZA: TwwDBLookupCombo
      ...
      AllowClearKey = False
      OnEnter = DBLC_REC_RAZAEnter
      OnExit = DBLC_REC_RAZAExit
    end
    object DBLC_REC_CGER1: TwwDBLookupCombo
      ...
      PreciseEditRegion = False
      AllowClearKey = False
      OnEnter = DBLC_REC_CGER1Enter
      OnExit = DBLC_REC_CGER1Exit
    end
    object DBLC_REC_CGER2: TwwDBLookupCombo
      Left = 139
      Top = 93
      Width = 122
      Height = 22
      ...
      PreciseEditRegion = False
      AllowClearKey = False
      OnEnter = DBLC_REC_CGER2Enter
      OnExit = DBLC_REC_CGER2Exit
    end
    object ME_REC_VENC1: TMaskEdit
      ...
      TabOrder = 2
      Text = '  /  /    '
      OnEnter = ME_REC_VENC1Enter
      OnExit = ME_REC_VENC1Exit
    end
    object ME_REC_VENC2: TMaskEdit
      ...
      TabOrder = 3
      Text = '  /  /    '
      OnEnter = ME_REC_VENC2Enter
      OnExit = ME_REC_VENC2Exit
    end
    object REC_SITU: TComboBox
      Left = 266
      Top = 93
      Width = 124
      Height = 22
    ...
    object chkLancamentoCaixa: TCheckBox
      Left = 219
      Top = 172
      Width = 174
      Height = 17
      Caption = 'Somente Lançamento de Caixa'
      TabOrder = 18
    end
  ...
  object Panel1: TPanel
    ...
    object DBG_CLIE: TwwDBGrid
      ...
      Height = 291
      Selected.Strings = (
        'REC_CODI'#9'8'#9'No. do CR'#9'F'#9
        'REC_RAZA'#9'35'#9'Cliente'#9'F'#9
        'FLAG_FLUXO'#9'1'#9'****'#9'F'#9
        'REC_NFIS'#9'10'#9'No. do Título'#9'F'#9
        'REC_VENC'#9'9'#9'Vencimento'#9'F'#9
        'REC_VLIQ'#9'10'#9'Valor Liquido'#9'F'#9
        'ValorReceber'#9'13'#9'Valor Recebido'#9'F'#9
        'REC_SALD'#9'10'#9'Saldo'#9'F'#9
        'REC_HIST'#9'40'#9'Histórico'#9'F'#9)
  ...
  object T_CONT: TwwQuery
    ...
    SQL.Strings = (
      ...
      #9#9'CON_ENSA, CON_OPER,CON_FLOA,CON_FLUX,CON_CTCO'
      'FROM '#9#9'CPACONT '
      'ORDER BY '#9'CON_CODI')
  ...
  object Q_RECE: TwwQuery
    ...
    object Q_RECEFLAG_FLUXO: TStringField
      ...
      OnChange = Q_RECEFLAG_FLUXOChange
      FixedChar = True
      Size = 1
    end
