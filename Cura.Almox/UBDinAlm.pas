...
uses UMenu ,  UReceb,
  ...
  URequisicaoPesq, URequisicao, UfrmSolicitacaoMateriais, UfrmBuscaMaterial;// Materiais, URecebPesq, URelBuscaDin, UKardex;
{$R *.DFM}
...
begin
 //  CLIC:= FALSE;    //VARIALVEL DA TELA DE PESQUISA RECEBIMENTO
   ...
   Begin
           ...
           FReceb.Q_REC.ParamS[0].AsInteger := StrToInt(Rec_ID);
           FReceb.ShowModal;
           FReceb.Release;
           Rec_ID:= '';
   End Else Begin
...
procedure TFBDinAlm.btnGetMaterialClick(Sender: TObject);
begin
