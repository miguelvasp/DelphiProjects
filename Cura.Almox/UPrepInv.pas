...
begin
  ...
  Excel.WorkBooks.Add;
   ...
   linha := 1;
    ...
    Excel.Cells[Linha, 1] := 'Inventário';
    ...
    Excel.Cells[Linha, 7] := 'Qtde Inventário';
    ...
    Excel.Cells[Linha, 13] := 'Data Atualização';
    Excel.Cells[Linha, 14] := 'Valor Reposição';
    Excel.Cells[Linha, 15] := 'Valor Estoque';
    Excel.Cells[Linha, 16] := 'Valor Diferença';
    Excel.Cells[Linha, 17] := 'Status';
    Excel.Cells[Linha, 18] := 'Local Armazem';
    Excel.Cells[Linha, 19] := 'Consumo Últimos 3 Meses';
