object FRelRecebRepr: TFRelRecebRepr
  Left = -3
  Top = -3
  Width = 810
  Height = 610
  ...
  object Q_Rec: TwwQuery
    ...
    SQL.Strings = (
      'Select D.REP_RAZA,A.REC_RAZA,A.REC_CODI,A.REC_NFIS,'
      'A.REC_EMIS,A.REC_VENC,'
      'A.REC_VORI,B.IRE_SALD,B.IRE_DATA,A.REC_SALD'
      'from cpaIrec B,CPARECE A, cpaclie c, SIAREPR D   '
      'where A.rec_clie = c.cli_codi '
      'and   A.REC_CODI = B.IRE_CODI '
      'and   D.REP_CODI = A.REC_REPR')
    ...
    object Q_RecREP_RAZA: TStringField
      FieldName = 'REP_RAZA'
      Origin = 'FINANCEIRO.SIAREPR.REP_RAZA'
      FixedChar = True
      Size = 50
    end
  end
