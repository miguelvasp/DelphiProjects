object FFiltRelChq: TFFiltRelChq
  Left = 312
  Top = 148
  ...
  object GRB_FILT: TGroupBox
    ...
    object cbo_CLIENTE_INI: TwwDBLookupCombo
      Left = 186
      Top = 54
      Width = 121
      Height = 22
    ...
    object cbo_CLIENTE_FIM: TwwDBLookupCombo
      Left = 338
      Top = 54
      Width = 121
      Height = 22
    ...
    object cbo_BANCO_INI: TwwDBLookupCombo
      Left = 186
      Top = 86
      Width = 121
      Height = 22
    ...
    object cbo_BANCO_FIM: TwwDBLookupCombo
      Left = 338
      Top = 85
      Width = 121
      Height = 22
  ...
  object Q_FORNI: TwwQuery
    ...
    Left = 496
    Top = 16
    object Q_FORNIFOR_CODI: TStringField
    ...
    object Q_FORNIFOR_RAZA: TStringField
      DisplayLabel = 'Razão'
      DisplayWidth = 50
      FieldName = 'FOR_RAZA'
  ...
  object Q_FORNF: TwwQuery
    ...
    Left = 544
    Top = 16
    object Q_FORNFFOR_CODI: TStringField
      DisplayLabel = 'Apelido'
      DisplayWidth = 15
      FieldName = 'FOR_CODI'
      Origin = 'FINANCEIRO.CPAFORN.FOR_CODI'
    ...
    object Q_FORNFFOR_RAZA: TStringField
      DisplayLabel = 'Razão'
      DisplayWidth = 50
      FieldName = 'FOR_RAZA'
      Origin = 'FINANCEIRO.CPAFORN.FOR_RAZA'
  ...
  object Q_BANCI: TwwQuery
    DatabaseName = 'Financeiro'
    SessionName = 'Sec_BaseFin'
    SQL.Strings = (
      'SELECT * FROM CPABANC ORDER BY BAN_NOME')
    ValidateWithMask = True
    Left = 166
    Top = 24
    object Q_BANCIBAN_NOME: TStringField
      DisplayLabel = 'Nome'
      DisplayWidth = 25
      FieldName = 'BAN_NOME'
    ...
    object Q_BANCIBAN_CODI: TStringField
      DisplayWidth = 50
      FieldName = 'BAN_CODI'
  ...
  object Q_BANCF: TwwQuery
    ...
    Left = 270
    Top = 32
    object Q_BANCFBAN_NOME: TStringField
      DisplayLabel = 'Nome'
      DisplayWidth = 25
      FieldName = 'BAN_NOME'
      Origin = 'FINANCEIRO.CPABANC.BAN_NOME'
    ...
    object Q_BANCFBAN_CODI: TStringField
      DisplayWidth = 50
      FieldName = 'BAN_CODI'
      Origin = 'FINANCEIRO.CPABANC.BAN_CODI'
      Visible = False
