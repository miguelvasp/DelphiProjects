object frmConsultaEstoqueMinMaxRequisicao: TfrmConsultaEstoqueMinMaxRequisicao
  ...
  Width = 1000
  Height = 650
  Caption = 'Consulta de Estoque Mínimo Máximo por Local'
  Color = clBtnFace
  ...
  object Panel2: TPanel
    ...
    object Button4: TButton
      ...
      Width = 209
      Height = 25
      Caption = 'Gerar Solicitação de Materiais'
      TabOrder = 0
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      ...
      'Media'#9'10'#9'Média'
      'EstoqueMinimo'#9'10'#9'Est. Mín'
      'EstoqueMaximo'#9'10'#9'Est. Máx.'
      'Selecionado'#9'3'#9'***'
