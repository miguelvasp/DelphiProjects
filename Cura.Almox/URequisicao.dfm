object FRequisicao: TFRequisicao
  ...
  Width = 1076
  Height = 682
  Caption = 'Requisição - Sistema de Almoxarifado'
  Color = clBtnFace
    ...
    object TTabPage
      ...
      object Panel2: TPanel
        ...
        object lbSolicitacao: TLabel
          ...
          Width = 145
          Height = 18
          Caption = 'Solicitações atendidas: '
          Font.Charset = ANSI_CHARSET
          Font.Color = clNavy
          Font.Height = -13
          Font.Name = 'Comic Sans MS'
        ...
        object Label22: TLabel
          ...
          Width = 242
          Height = 18
          Caption = 'Observação da Solicitação de Materiais'
          Font.Charset = ANSI_CHARSET
          Font.Color = clNavy
          Font.Height = -13
          Font.Name = 'Comic Sans MS'
        ...
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            'Req_ID'#9'10'#9'N°'
            'Data'#9'19'#9'Data da Requisição'
            'CC_Desc'#9'35'#9'Centro Custo'
            'Data_Sist'#9'15'#9'Data '
            'Usuario'#9'19'#9'Usuário'
        ...
        object wwDBComboBox1: TwwDBComboBox
          ...
          ItemHeight = 0
          Items.Strings = (
            'Requisição de Materiais'#9'R'
            'Transferência de Materiais'#9'T')
          Sorted = False
          TabOrder = 2
          UnboundDataType = wwDefault
          Visible = False
    ...
    object TTabPage
      ...
      object Panel4: TPanel
        ...
        object Label3: TLabel
          ...
          Width = 256
          Height = 18
          Caption = 'Lotes para atender aos itens da requisição'
          Font.Charset = ANSI_CHARSET
          Font.Color = clNavy
          Font.Height = -13
          Font.Name = 'Comic Sans MS'
        ...
        object Label5: TLabel
          ...
          Width = 143
          Height = 18
          Caption = 'Preferência pela Marca'
          Font.Charset = ANSI_CHARSET
          Font.Color = clNavy
          Font.Height = -13
          Font.Name = 'Comic Sans MS'
        ...
        object btSimul: TSpeedButton
          ...
          Width = 116
          Height = 26
          Hint = 'Simular Alocação de Materiais'
        ...
        object Label14: TLabel
          ...
          Width = 219
          Height = 18
          Caption = 'Materiais que precisam de liberação'
          Color = clRed
          ParentColor = False
        end
        object Label16: TLabel
          ...
          Width = 207
          Height = 18
          Caption = 'Material acima do Estoque máximo'
          Color = clYellow
          ParentColor = False
          Visible = False
        end
        ...
        object Grid: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'InformacaoAdicional'#9'100'#9'Informação Adicional'#9#9)
          IniAttributes.FileName = 'delphi32.ini'
          IniAttributes.SectionName = 'FPcPGridx'
          IniAttributes.Delimiter = ';;'
        ...
        object Button4: TButton
          ...
          Width = 233
          Height = 25
          Caption = 'Usar Leitor de Código de barras'
          TabOrder = 6
  ...
  object Q_REQY: TwwQuery
    ...
    object Q_REQYData: TDateTimeField
      DisplayLabel = 'Data da Requisição'
      DisplayWidth = 19
      FieldName = 'Data'
  ...
  object Q_REQ_ITEM: TwwQuery
    ...
    object Q_REQ_ITEMInformacaoAdicional: TStringField
      DisplayLabel = 'Informação Adicional'
      DisplayWidth = 100
