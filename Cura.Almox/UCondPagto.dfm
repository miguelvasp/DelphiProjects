object FCondPagto: TFCondPagto
  ...
  Width = 799
  Height = 572
  Caption = 'Condições de Pagamento - Sistema de Almoxarifado'
  Color = clBtnFace
  ...
  object TabbedNotebook1: TTabbedNotebook
    ...
    object TTabPage
      ...
      object Panel2: TPanel
        ...
        object DBE_COND_DESC: TwwDBEdit
          Left = 106
          Top = 28
          Width = 288
          Height = 26
          ...
          WantReturns = False
          WordWrap = False
          OnEnter = DBE_COND_DESCEnter
          OnExit = DBE_COND_DESCExit
        end
        object wwDBGrid1: TwwDBGrid
          ...
          Selected.Strings = (
            ...
            'NUM_PARCELAS'#9'34'#9'Número de Parcelas'#9'F')
        ...
        object DBE_COD_NUMPARC: TwwDBEdit
          Left = 106
          Top = 70
          Width = 57
          Height = 26
          ...
          WantReturns = False
          WordWrap = False
          OnEnter = DBE_COD_NUMPARCEnter
          OnExit = DBE_COD_NUMPARCExit
        end
        object DBCB_COND_FORA: TwwDBComboBox
          Left = 106
          Top = 97
          Width = 128
          Height = 26
          ...
          TabOrder = 2
          UnboundDataType = wwDefault
          OnEnter = DBCB_COND_FORAEnter
          OnExit = DBCB_COND_FORAExit
        end
        object wwDBLookupCombo1: TwwDBLookupCombo
          ...
          Selected.Strings = (
            'pgtoBio_desc'#9'255'#9'pgtoBio_desc'#9#9)
          DataField = 'pgtoBio_id'
          DataSource = DS_COND
          LookupTable = qrBionexo
          LookupField = 'pgtoBio_id'
          TabOrder = 4
          AutoDropDown = False
          ShowButton = True
    ...
    object TTabPage
      ...
      object Panel3: TPanel
        ...
        object wwDBGrid2: TwwDBGrid
          ...
          Height = 236
          Selected.Strings = (
            'NUM_DIAS'#9'15'#9'N º de Dias'
            'PERCENTUAL'#9'15'#9'Percentual'#9'F')
          IniAttributes.Delimiter = ';;'
          TitleColor = clLime
          FixedCols = 0
          ShowHorzScrollBar = True
  ...
  object Q_COND: TwwQuery
    CachedUpdates = True
    BeforePost = Q_CONDBeforePost
    AfterPost = Q_CONDAfterPost
    AfterDelete = Q_CONDAfterDelete
    AfterScroll = Q_CONDAfterScroll
    OnNewRecord = Q_CONDNewRecord
    DatabaseName = 'CURA'
    ...
    object Q_CONDpgtoBio_id: TIntegerField
      FieldName = 'pgtoBio_id'
      Origin = 'CURA.CONDICAO_PAGTO.pgtoBio_id'
    end
  end
  object DS_COND: TwwDataSource
    DataSet = Q_COND
    OnStateChange = DS_CONDStateChange
    Left = 460
    Top = 67
  end
  object Q_CONDI: TwwQuery
    CachedUpdates = True
    AfterPost = Q_CONDIAfterPost
    AfterDelete = Q_CONDIAfterDelete
    OnNewRecord = Q_CONDINewRecord
    DatabaseName = 'CURA'
    SessionName = 'Sec_BaseFin'
    DataSource = DS_COND
    RequestLive = True
  ...
  object DS_CONDI: TwwDataSource
    DataSet = Q_CONDI
    OnStateChange = DS_CONDIStateChange
    Left = 620
    Top = 67
  end
  ...
  object PESQ_COND: TwwSearchDialog
    Selected.Strings = (
      'DESCRICAO'#9'35'#9'DESCRICAO'#9'F')
    GridTitleAlignment = taLeftJustify
    GridColor = clWhite
    GridOptions = [dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    SearchTable = Q_PSQCOND
    Caption = 'Pesquisa de Condições de Pagamento'
    MaxWidth = 0
    MaxHeight = 209
    CharCase = ecNormal
    Left = 664
  ...
  object Q_PSQCOND: TwwQuery
    ...
    Left = 664
    Top = 136
    object Q_PSQCONDDESCRICAO: TStringField
      DisplayWidth = 35
      FieldName = 'DESCRICAO'
      Origin = 'CURA.CONDICAO_PAGTO.DESCRICAO'
      FixedChar = True
    ...
    object Q_PSQCONDCOND_PGTO_ID: TAutoIncField
      DisplayWidth = 10
      FieldName = 'COND_PGTO_ID'
      Origin = 'CURA.CONDICAO_PAGTO.COND_PGTO_ID'
      Visible = False
    end
    object Q_PSQCONDNUM_PARCELAS: TFloatField
      DisplayWidth = 10
      FieldName = 'NUM_PARCELAS'
      Origin = 'CURA.CONDICAO_PAGTO.NUM_PARCELAS'
      Visible = False
    end
    object Q_PSQCONDPAGAMENTO: TStringField
      DisplayWidth = 2
      FieldName = 'PAGAMENTO'
      Origin = 'CURA.CONDICAO_PAGTO.PAGAMENTO'
      Visible = False
    ...
    object Q_PSQCONDFORA: TStringField
      DisplayWidth = 1
      FieldName = 'FORA'
      Origin = 'CURA.CONDICAO_PAGTO.FORA'
      Visible = False
  ...
  object PESQ_CONDI: TwwSearchDialog
    Selected.Strings = (
      'NUM_DIAS'#9'10'#9'NUM_DIAS'#9'F')
    GridTitleAlignment = taLeftJustify
    GridColor = clWhite
    GridOptions = [dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgRowSelect, dgAlwaysShowSelection, dgConfirmDelete, dgPerfectRowFit]
    SearchTable = Q_PSQCONDI
    Caption = 'Pesquisa de Condições de Pagamento'
    MaxWidth = 0
    MaxHeight = 209
    CharCase = ecNormal
  ...
  object Q_PSQCONDI: TwwQuery
    ...
    Left = 728
    Top = 119
    object Q_PSQCONDINUM_DIAS: TFloatField
      DisplayWidth = 10
      FieldName = 'NUM_DIAS'
      Origin = 'CURA.CONDICAO_PAGTO_INTERVALO.NUM_DIAS'
    end
    object Q_PSQCONDIINTERVALO_ID: TAutoIncField
      DisplayWidth = 10
      FieldName = 'INTERVALO_ID'
      Origin = 'CURA.CONDICAO_PAGTO_INTERVALO.INTERVALO_ID'
      Visible = False
    end
    object Q_PSQCONDICOND_PGTO_ID: TIntegerField
      DisplayWidth = 10
      FieldName = 'COND_PGTO_ID'
      Origin = 'CURA.CONDICAO_PAGTO_INTERVALO.COND_PGTO_ID'
      Visible = False
    end
    object Q_PSQCONDIPERCENTUAL: TFloatField
      DisplayWidth = 10
      FieldName = 'PERCENTUAL'
      Origin = 'CURA.CONDICAO_PAGTO_INTERVALO.PERCENTUAL'
      Visible = False
  ...
  object qrBionexo: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'select * from dbo.pgtoBionexo'
      'order by pgtoBio_desc')
    Left = 740
    Top = 301
    object qrBionexopgtoBio_desc: TStringField
      DisplayWidth = 255
      FieldName = 'pgtoBio_desc'
      Size = 255
    end
    object qrBionexopgtoBio_id: TIntegerField
      DisplayWidth = 10
      FieldName = 'pgtoBio_id'
      Visible = False
    end
