object frmRelMateriaisInativos: TfrmRelMateriaisInativos
  Left = 259
  Top = 151
  Width = 1072
  Height = 563
  ...
  object RzPageControl1: TRzPageControl
    ...
    object TabSheet1: TRzTabSheet
      ...
      object Label2: TLabel
        ...
        Width = 267
        Height = 16
        Caption = 'Pesquisar materiais antes da data informada'
      end
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Height = 364
    Selected.Strings = (
      'GRU_DESC'#9'40'#9'Grupo'#9'F'#9
      'MAT_DESC'#9'100'#9'Material'#9'F'#9
      'Data'#9'18'#9'Data Última Requisição'#9'F'#9
  ...
  object qrBusca: TADOQuery
    ...
    Parameters = <>
    SQL.Strings = (
      'SELECT * FROM vwMateriaisInativos')
    Left = 432
    Top = 280
    ...
    object qrBuscaData: TDateTimeField
      DisplayLabel = 'Data Última Requisição'
      DisplayWidth = 18
      FieldName = 'Data'
      ReadOnly = True
