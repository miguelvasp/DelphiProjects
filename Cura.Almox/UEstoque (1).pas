...
uses UrelEstoque, UMenu, UfrmRelConsumoSemPreco,
  UfrmRelConsumoTotalComPreco, ufrmRelResumo;
...
begin
   ...
   begin
       ...
       sql.Clear;
       sql.Add(
             ' SELECT dbo.MATERIAIS.MAT_ID, dbo.Req_Item.Req_Item_ID,'+
             ' dbo.Req_Item.Req_ID, '+
             ' dbo.Req_Capa.Data, '+
...
begin
  ...
  with frmRelConsumoSemPreco.qrRel do begin
       ...
       sql.Add(      ' dbo.MATERIAIS.MAT_DESC, ');
       ...
       SQL.Add(' AND MATERIAIS.RelConsumo = ''S'' ');
           ...
           sql.Add(' GROUP BY dbo.MATERIAIS.MAT_ID, dbo.MATERIAIS.MAT_DESC, dbo.Req_Item.Uni_Sigla ');
...
begin
  ...
  with frmRelResumo.qrRel do begin
       Close;
       sql.Clear;
       sql.Add(      ' SELECT 	dbo.MATERIAIS.MAT_DESC,');
