...
uses
  ...
  Wwdbcomb, Qrctrls, Db, gtQrCtrls, ADODB, Buttons;
...
begin
   with qrBusca do begin
       ...
       if cboTipoOC.Text <> '' then
       begin
           sql.Add('AND TipoCompra = ' + QuotedStr(cboTipoOC.Text));
           filtro := filtro + ' Tipo de Compra: ' + cboTipoOC.Text;
       end;
...
procedure TfrmRelOCCompras.btnGetMaterialClick(Sender: TObject);
begin
