object frmRelManiGeral: TfrmRelManiGeral
  Left = 203
  Top = 153
  Width = 1090
  Height = 650
  Caption = 'frmRelManiGeral'
  Color = clBtnFace
  ...
  object ROM: TQuickRep
    ...
    object QRBand1: TQRBand
      ...
      object QRDBText11: TQRDBText
        ...
        AutoStretch = False
        Color = clWhite
        DataSet = FManifesto_Geral.Q_ESTQ
        DataField = 'MANI_ID'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -21
  ...
  object Q_PROD: TwwQuery
    ...
    DataSource = FManifesto_Geral.DS_ESTQ
    SQL.Strings = (
  ...
  object Q_ESTQ: TwwQuery
    ...
    SQL.Strings = (
      ...
      'order by B.PRO_COD,AR_ID,POS_ID,ESTQ_QTDE desc')
    ValidateWithMask = True
    Left = 656
    Top = 312
    ParamData = <
    ...
    object Q_ESTQGEROU_OPER_ROMSAIDA: TStringField
      ...
      Origin = 'NBFDADOS.ESTOQUE_GERAL.GEROU_OPER_ROMSAIDA'
      FixedChar = True
      Size = 1
    end
    object Q_ESTQMARCADOR: TStringField
      FieldName = 'MARCADOR'
      Origin = 'NBFDADOS.ESTOQUE_GERAL.MARCADOR'
      FixedChar = True
      Size = 1
    end
    object Q_ESTQESTQ_ESCOLHEULOTE: TStringField
      FieldName = 'ESTQ_ESCOLHEULOTE'
      Origin = 'NBFDADOS.ESTOQUE_GERAL.ESTQ_ESCOLHEULOTE'
      FixedChar = True
      Size = 1
    end
    object Q_ESTQQTDE_GERAL: TFloatField
      FieldName = 'QTDE_GERAL'
      Origin = 'NBFDADOS.ESTOQUE_GERAL.QTDE_GERAL'
    end
    object Q_ESTQPRO_ID_1: TAutoIncField
      FieldName = 'PRO_ID_1'
      Origin = 'NBFDADOS.PRODUTO.PRO_ID'
    end
    ...
    object Q_ESTQTPRO_ID: TIntegerField
      FieldName = 'TPRO_ID'
      Origin = 'NBFDADOS.PRODUTO.TPRO_ID'
    end
    object Q_ESTQPRO_ORIGEM: TStringField
      FieldName = 'PRO_ORIGEM'
      Origin = 'NBFDADOS.PRODUTO.PRO_ORIGEM'
      FixedChar = True
      Size = 1
    end
    object Q_ESTQUVEN_ID_1: TIntegerField
      FieldName = 'UVEN_ID_1'
      Origin = 'NBFDADOS.PRODUTO.UVEN_ID'
    end
    object Q_ESTQUVEN_ID_EXP: TIntegerField
      FieldName = 'UVEN_ID_EXP'
      Origin = 'NBFDADOS.PRODUTO.UVEN_ID_EXP'
    end
    object Q_ESTQQTDE_UVUE: TFloatField
      FieldName = 'QTDE_UVUE'
      Origin = 'NBFDADOS.PRODUTO.QTDE_UVUE'
    end
    object Q_ESTQPRO_QTDE_PALLET: TIntegerField
      FieldName = 'PRO_QTDE_PALLET'
      Origin = 'NBFDADOS.PRODUTO.PRO_QTDE_PALLET'
    end
    object Q_ESTQPRO_QTDE_PALLETUV: TFloatField
      FieldName = 'PRO_QTDE_PALLETUV'
      Origin = 'NBFDADOS.PRODUTO.PRO_QTDE_PALLETUV'
    end
    object Q_ESTQPRO_PESO: TFloatField
      FieldName = 'PRO_PESO'
      Origin = 'NBFDADOS.PRODUTO.PRO_PESO'
    end
    object Q_ESTQPRO_VOLUME: TFloatField
      FieldName = 'PRO_VOLUME'
      Origin = 'NBFDADOS.PRODUTO.PRO_VOLUME'
    end
    object Q_ESTQPRO_VOLUME_PALLET: TFloatField
      FieldName = 'PRO_VOLUME_PALLET'
      Origin = 'NBFDADOS.PRODUTO.PRO_VOLUME_PALLET'
    end
    object Q_ESTQPRO_ALTURA: TIntegerField
      FieldName = 'PRO_ALTURA'
      Origin = 'NBFDADOS.PRODUTO.PRO_ALTURA'
    end
    object Q_ESTQPRO_LASTRO: TIntegerField
      FieldName = 'PRO_LASTRO'
      Origin = 'NBFDADOS.PRODUTO.PRO_LASTRO'
    end
    object Q_ESTQPRO_VALIDDIAS: TIntegerField
      FieldName = 'PRO_VALIDDIAS'
      Origin = 'NBFDADOS.PRODUTO.PRO_VALIDDIAS'
    end
    object Q_ESTQMARCADOR_1: TStringField
      FieldName = 'MARCADOR_1'
      Origin = 'NBFDADOS.PRODUTO.MARCADOR'
      FixedChar = True
      Size = 1
    end
    object Q_ESTQPRO_PESO_LIQ: TFloatField
      FieldName = 'PRO_PESO_LIQ'
      Origin = 'NBFDADOS.PRODUTO.PRO_PESO_LIQ'
    end
    object Q_ESTQPRO_DESCONTINUA: TStringField
      FieldName = 'PRO_DESCONTINUA'
      Origin = 'NBFDADOS.PRODUTO.PRO_DESCONTINUA'
      FixedChar = True
      Size = 1
    end
    object Q_ESTQPRO_COMPR: TFloatField
      FieldName = 'PRO_COMPR'
      Origin = 'NBFDADOS.PRODUTO.PRO_COMPR'
    end
    object Q_ESTQPRO_LARG: TFloatField
      FieldName = 'PRO_LARG'
      Origin = 'NBFDADOS.PRODUTO.PRO_LARG'
    end
    object Q_ESTQPRO_ALT: TFloatField
      FieldName = 'PRO_ALT'
      Origin = 'NBFDADOS.PRODUTO.PRO_ALT'
    end
    object Q_ESTQPRO_REDUZICMS: TFloatField
      FieldName = 'PRO_REDUZICMS'
      Origin = 'NBFDADOS.PRODUTO.PRO_REDUZICMS'
    end
    object Q_ESTQPRO_ISENCAO: TStringField
      FieldName = 'PRO_ISENCAO'
      Origin = 'NBFDADOS.PRODUTO.PRO_ISENCAO'
      FixedChar = True
      Size = 1
    end
    object Q_ESTQPRO_ICMS: TFloatField
      FieldName = 'PRO_ICMS'
      Origin = 'NBFDADOS.PRODUTO.PRO_ICMS'
    end
    object Q_ESTQPRO_CST1: TStringField
      FieldName = 'PRO_CST1'
      Origin = 'NBFDADOS.PRODUTO.PRO_CST1'
      FixedChar = True
      Size = 7
    end
    object Q_ESTQPRO_CST2: TStringField
      FieldName = 'PRO_CST2'
      Origin = 'NBFDADOS.PRODUTO.PRO_CST2'
      FixedChar = True
      Size = 7
    end
    object Q_ESTQPRO_CST3: TStringField
      FieldName = 'PRO_CST3'
      Origin = 'NBFDADOS.PRODUTO.PRO_CST3'
      FixedChar = True
      Size = 7
    end
    object Q_ESTQPRO_CST4: TStringField
      FieldName = 'PRO_CST4'
      Origin = 'NBFDADOS.PRODUTO.PRO_CST4'
      FixedChar = True
      Size = 7
    end
    object Q_ESTQPRO_CST5: TStringField
      FieldName = 'PRO_CST5'
      Origin = 'NBFDADOS.PRODUTO.PRO_CST5'
      FixedChar = True
      Size = 7
    end
    object Q_ESTQPRO_CST6: TStringField
      FieldName = 'PRO_CST6'
      Origin = 'NBFDADOS.PRODUTO.PRO_CST6'
      FixedChar = True
      Size = 7
    end
    object Q_ESTQULTIMO_PRECO: TFloatField
  ...
  object qrAux: TADOQuery
    ...
    SQL.Strings = (
      'SELECT NFS_GERAL FROM MANIFESTO WHERE MANI_ID = :MANI_ID')
    Left = 444
    Top = 261
    object qrAuxNFS_GERAL: TStringField
      FieldName = 'NFS_GERAL'
      Size = 4000
    end
  end
