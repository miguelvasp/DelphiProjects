object frmDespesasFrete: TfrmDespesasFrete
  Left = 271
  Top = 105
  Width = 842
  Height = 600
  Caption = 'Despesas de Transportadoras - Consulta'
  Color = clBtnFace
  ...
  object wwDBGrid1: TwwDBGrid
    ...
    Selected.Strings = (
      'DATA'#9'10'#9'Data'
      'Transportadora'#9'45'#9'Transportadora'
      'Tipo_desc'#9'40'#9'Tipo'
      'VALOR'#9'10'#9'Valor')
  ...
  object qrDespesas: TADOQuery
    ...
    object qrDespesasTransportadora: TStringField
      DisplayWidth = 45
      FieldKind = fkLookup
    ...
    object qrDespesasTipo_desc: TStringField
      DisplayLabel = 'Tipo'
      DisplayWidth = 40
      FieldKind = fkLookup
      FieldName = 'Tipo_desc'
      LookupDataSet = qrTipo
      LookupKeyFields = 'ID'
