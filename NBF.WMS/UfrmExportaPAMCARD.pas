...
begin
    try
           try
                ...
                f.Add('#viagem.unidade.documento.tipo=1'); //1 indica q é CNPJ
                ...
                if qrMunIbgeCOD_MUN.AsString = '' then ShowMessage('Manifesto código: ' + qrDadosMANI_ID.AsString + ' com municipio de origem sem vinculo com a tabela IBGE');
               ...
               // if qrMunIbgeCOD_MUN.AsString = '' then ShowMessage('Conhecimento código: ' + qrDadosORD_ID.AsString + ' com municipio de destino sem vinculo com a tabela IBGE');
                ...
                //COMEÇAMOS A LISTAR OS CONHECIMENTOS DO MANIFESTO
                      ...
                      while not qrConhecimento.Eof do begin
                                ...
                                if qrMunIbgeCOD_MUN.AsString = '' then ShowMessage('Manifesto código: ' + qrDadosMANI_ID.AsString + ' com municipio do remetente da nota fiscal '+ qrConhecimentoORD_CONH.AsString + ' sem vinculo com a tabela IBGE');
                                ...
                                //escrevemos os dados do destinatário.
                                ...
                                if qrMunIbgeCOD_MUN.AsString = '' then ShowMessage('Conhecimento código: ' + qrDadosMANI_ID.AsString + ' com municipio do destinatário do conhecimento '+ qrConhecimentoORD_CONH.AsString + ' sem vinculo com a tabela IBGE');
                ...
                IF qrDadosORD_COLETA_ENTREGA.AsString = 'C' then begin
                      ...
                      while not qrNotas.Eof do begin
                                ...
                                if qrMunIbgeCOD_MUN.AsString = '' then ShowMessage('Conhecimento código: ' + qrDadosORD_ID.AsString + ' com municipio do remetente da nota fiscal '+ qrNotasNFI_NUMERO.AsString + ' sem vinculo com a tabela IBGE');
                                ...
                                if qrMunIbgeCOD_MUN.AsString = '' then ShowMessage('Conhecimento código: ' + qrDadosORD_ID.AsString + ' com municipio do destinatário da nota fiscal '+ qrNotasNFI_NUMERO.AsString + ' sem vinculo com a tabela IBGE');
                ...
                f.Add('viagem.parcela1.efetivacao.tipo=1');  //EFETIVAÇÃO MANUAL, PARA AUTOMATICA MUDAR PARA 2
...
begin
   IF qrBuscaSEL_CIOT.AsString = 'S' then begin
        ...
        begin
            ShowMessage('Manifesto possui conhecimentos sem confirmação de valores.');
