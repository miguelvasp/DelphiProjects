object FOS: TFOS
  ...
  object Panel2: TPanel
    ...
    object SpeedButton4: TSpeedButton
      ...
      Width = 25
      Height = 25
      Hint = 'Pesquisar Ordem de Serviço'
      Glyph.Data = {
    ...
    object TTabPage
      ...
      object Panel1: TPanel
        ...
        object Label8: TLabel
          ...
          Alignment = taCenter
          AutoSize = False
          Caption = 'Ordem de Serviço não concluída'
          Color = clRed
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clWhite
          Font.Height = -21
        ...
        object Panel4: TPanel
          ...
          object BitBtn1: TBitBtn
            ...
            Width = 284
            Height = 41
            Caption = ' Gerar  Serviços / Especificações'
            Font.Charset = ANSI_CHARSET
            Font.Color = clNavy
            Font.Height = -16
            Font.Name = 'Arial'
          ...
          object BitBtn2: TBitBtn
            ...
            Width = 284
            Height = 41
            Caption = ' Concluir Ordem de Serviço'
            Font.Charset = ANSI_CHARSET
            Font.Color = clNavy
            Font.Height = -16
            Font.Name = 'Arial'
    ...
    object TTabPage
      ...
      object TabbedNotebook2: TTabbedNotebook
        ...
        object TTabPage
          ...
          object Panel8: TPanel
            ...
            object wwDBGrid1: TwwDBGrid
              ...
              Hint = 'Visualização dos Registros'
              Selected.Strings = (
                'TSER_NOME'#9'40'#9'Tipo de Serviço'
                'SER_NOME'#9'40'#9'Serviço'
        ...
        object TTabPage
          Left = 4
          Top = 24
          Caption = '   Especificações por Serviços   '
          ...
          object Panel3: TPanel
            ...
            object wwDBGrid3: TwwDBGrid
              ...
              Selected.Strings = (
                ...
                'OS_ESPEC_AREA_DE'#9'10'#9'Faixa de Área(M2) de'
                'OS_ESPEC_AREA_ATE'#9'10'#9'Faixa de Área(M2) até'
                'OS_ESPEC_QTDEPALLET_DE'#9'10'#9'Faixa de Qtde.(Pallets) de'
                'OS_ESPEC_QTDEPALLET_ATE'#9'10'#9'Faixa de Qtde.(Pallets) até'
                'OS_ESPEC_PESO_DE'#9'10'#9'Faixa de Peso(Ton.) de'
                'OS_ESPEC_PESO_ATE'#9'10'#9'Faixa de Peso(Ton.) até'
                'OS_ESPEC_VOL_DE'#9'10'#9'Faixa de Volume(M3) de'
                'OS_ESPEC_VOL_ATE'#9'10'#9'Faixa de Volume(M3) até')
              IniAttributes.FileName = 'delphi32.ini'
        ...
        object TabSheet1: TRzTabSheet
          ...
          object wwDBGrid5: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'ORD_VLR_PEDAGIO'#9'10'#9'Pedágio'
        ...
        object TabSheet2: TRzTabSheet
          ...
          object DBG_INFI: TwwDBGrid
            ...
            Selected.Strings = (
              ...
              'CALC_UNITARIO'#9'13'#9'Unitário'#9'F'
              'UCOB_NOME'#9'24'#9'Unidade Cobrança'#9'F'
  ...
  object Panel11: TPanel
    ...
    object Grid: TwwDBGrid
      ...
      Selected.Strings = (
        ...
        'NFI_NUMERO'#9'10'#9'Nota Fiscal Nº'#9'F')
      IniAttributes.FileName = 'delphi32.ini'
  ...
  object Q_OSESPEC: TwwQuery
    ...
    object Q_OSESPECOS_ESPEC_AREA_DE: TFloatField
      DisplayLabel = 'Faixa de Área(M2) de'
      DisplayWidth = 10
    ...
    object Q_OSESPECOS_ESPEC_AREA_ATE: TFloatField
      DisplayLabel = 'Faixa de Área(M2) até'
      DisplayWidth = 10
    ...
    object Q_OSESPECOS_ESPEC_QTDEPALLET_ATE: TIntegerField
      DisplayLabel = 'Faixa de Qtde.(Pallets) até'
      DisplayWidth = 10
    ...
    object Q_OSESPECOS_ESPEC_PESO_ATE: TFloatField
      DisplayLabel = 'Faixa de Peso(Ton.) até'
      DisplayWidth = 10
    ...
    object Q_OSESPECOS_ESPEC_VOL_ATE: TFloatField
      DisplayLabel = 'Faixa de Volume(M3) até'
      DisplayWidth = 10
