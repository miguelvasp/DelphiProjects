...
type
  TfrmRelTransporte2 = class(TForm)
    ...
    qrDetalheTRANS_ID: TIntegerField;
    qrDetalheTRANSPORTADORA: TStringField;
    qrDetalhePLACA: TStringField;
...
begin
 ...
 // Sheet.Range['A'].NumberFormat := 'm/d/yyyy';
  ...
  Sheet.cells[4,12].value := 'TRANSPORTADORA';
  Sheet.cells[4,13].value := 'PLACA';
  ...
  begin  //buscamos os produtos
        ...
        begin
                ...
                Sheet.cells[linha,12].value := qrDetalheTRANSPORTADORA.AsString;
                Sheet.cells[linha,13].value := qrDetalhePLACA.AsString;
